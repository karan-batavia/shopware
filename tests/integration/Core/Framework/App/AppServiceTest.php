...
class AppServiceTest extends TestCase
{
    ...
    {
        $this->appService->doRefreshApps(new AppOptionsInstall(activate: true), $this->context);
    ...
    public function testInstallFailureDoesNotAffectAllApps(): void
    {
        ...
        $fails = $appService->doRefreshApps(new AppOptionsInstall(activate: true), $this->context);
        $apps = $this->appRepository->search(new Criteria(), $this->context)->getEntities();
