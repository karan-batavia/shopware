...
class AppLifecycleTest extends TestCase
{
    ...
    public function testInstallNotCompatibleApp(): void
    {
        ...
        $appLifecycle->install($manifest, new AppOptionsInstall(true), Context::createDefaultContext());
    }
    ...
    public function testUpdateNotCompatibleApp(): void
    {
        ...
        $this->expectException(AppException::class);
        $this->expectExceptionMessage('App test is not compatible with this Shopware version');
        $appLifecycle->update($manifest, new AppOptionsUpdate(), ['id' => 'test', 'roleId' => 'test'], Context::createDefaultContext());
    }
    ...
    public function testInstallSavesSnippetsGiven(): void
    {
        ...
        $appLifecycle->install($manifest, new AppOptionsInstall(false), Context::createDefaultContext());
    ...
    public function testUpdateSavesNoSnippetsGiven(): void
    {
        ...
        $appLifecycle->update($manifest, new AppOptionsUpdate(), ['id' => 'appId', 'roleId' => 'roleId'], Context::createDefaultContext());
